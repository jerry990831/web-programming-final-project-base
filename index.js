...
express()
  ...
  .post('/sql', async(req, res)=> {
	  ...
	  const query_2 = "INSERT INTO pokemon(\"Pokemon\",\"HP\",\"Atk\",\"Def\",\"SpA\",\"SpD\",\"Spe\") VALUES('" + pokemon_name + "'" + "," + hp + "," + atk + "," + def + "," + sp_atk + "," + sp_def + "," + speed + ");"
  ...
  .get('/yichengwang', (req, res) => res.render('pages/yichengwang'))
